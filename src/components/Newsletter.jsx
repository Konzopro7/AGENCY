...
export function Newsletter({ lang = "fr", compact = false }) {
  ...
  const copy =
    lang === "en"
      ...
      : {
          eyebrow: "Newsletter",
          title: "Recevez chaque mois nos conseils de croissance",
          subtitle: "Des conseils concrets sur le Web, le SEO et la conversion, partagés par notre équipe.",
          perk1: "Conseils pratiques pour votre site Web",
          perk2: "Alertes SEO et performance",
          perk3: "Offres de lancement exclusives",
          email: "Courriel professionnel",
          emailPlaceholder: "vous@entreprise.com",
          consent: "J’accepte de recevoir les courriels marketing de KonzoTech Agency.",
          submit: "S'inscrire",
          sending: "Envoi...",
          success: "Inscription confirmée. Bienvenue.",
          invalidEmail: "Merci de saisir une adresse courriel valide.",
          missingConsent: "Le consentement marketing est requis.",
          missingConfig: "Le point d’accès de l’infolettre n’est pas configuré.",
          genericError: "Inscription impossible pour le moment. Réessayez.",
          networkError: "Connexion bloquée (réseau ou certificat SSL). Réessayez en navigation privée ou contactez le support.",
          policy: "Désinscription possible à tout moment.",
          subject: `Inscription newsletter - ${SITE.name}`,
          barTitle: "Infolettre mensuelle sur la croissance",
