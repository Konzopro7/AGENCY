  ...
  const copy =
    lang === "en"
      ...
      : {
          ...
          subtitle:
            "Dites-nous ce que vous vendez, à qui et ce que vous souhaitez améliorer. Nous vous répondrons rapidement.",
          directTitle: "Contact direct",
          directSub: "Réponse rapide par courriel ou par téléphone.",
          quoteTag: "Devis clair + options",
          deadlineTag: "Délais annoncés",
          supportTag: "Suivi après livraison",
          messageMode: "Message",
          ...
          needsPlaceholder: "Sélectionnez votre besoin principal",
          messagePlaceholder: "Objectif du site, pages, exemples, budget et délai si possible…",
          detailsPlaceholder: "Précisez votre contexte, vos objectifs et vos attentes pour le rendez-vous.",
          send: "Envoyer",
          sendBooking: "Demander un rendez-vous",
          sending: "Envoi...",
          success: "Merci. Votre message a bien été envoyé. Nous vous répondrons sous 24 h.",
          bookingSuccess: "Merci. Votre demande de rendez-vous a été envoyée. Vous recevrez rapidement une confirmation par courriel.",
          hint: "Réponse sous 24 h (jours ouvrés).",
          bookingHint: "Ajoutez un maximum de contexte pour préparer un appel utile et efficace.",
          invalidName: "Merci d’indiquer votre nom.",
          invalidEmail: "Adresse courriel invalide.",
          invalidPhone: "Merci d’indiquer un numéro valide.",
          invalidDate: "Merci de choisir une date valide.",
          invalidTime: "Merci de choisir une heure.",
          invalidNeeds: "Merci de sélectionner un besoin principal.",
          invalidMessage: "Message trop court (10 caractères minimum).",
          invalidDetails: "Merci d’ajouter des détails (10 caractères minimum).",
          missingConfig: "Configuration de contact introuvable.",
          genericError: "Une erreur est survenue. Réessayez.",
          networkError: "Connexion bloquée (réseau ou certificat SSL). Réessayez en navigation privée ou contactez le support.",
